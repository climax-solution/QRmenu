      ...
      <div className="share-friend d-flex justify-content-between bg-dark rct-block py-40 px-30">
        <div className="w-70">
          ...
          <ul className="social-share list-inline">
            <li className="list-inline-item"><a href="#" className="bg-facebook"><i className="ti-facebook"></i></a></li>
            <li className="list-inline-item"><a href="#" className="bg-twitter"><i className="ti-twitter-alt"></i></a></li>
            <li className="list-inline-item"><a href="#" className="bg-instagram"><i className="ti-instagram"></i></a></li>
            <li className="list-inline-item"> <a href="#" className="bg-google"><i className="ti-google"></i></a></li>
          </ul>
        </div>

                                        ...
                                        <div className="ct-notice-content d-block">
                                            <div className="row">
                                                ...
                                                <div className="col-12">
                                                    <button type="submit" className="btn-custom shadow-none btn-sm" name="button">Login</button>
                                                </div>
                                            </div>
                                        </div>
                                    </Accordion.Collapse>
                                        ...
                                        <div className="ct-notice-content d-block">
                                            ...
                                            <div className="input-group">
                                                ...
                                                <div className="input-group-append">
                                                    <button className="btn-custom shadow-none" type="button">Apply Code</button>
                                                </div>
                                            </div>
                                        </div>
                                    </Accordion.Collapse>
